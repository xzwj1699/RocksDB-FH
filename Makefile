...
fh_lru_cache_test: $(OBJ_DIR)/cache/fh_lru_cache_test.o $(TEST_LIBRARY) $(LIBRARY)
	$(AM_LINK)
...
JAVA_COMPRESSIONS = liblz4.a
endif

# JAVA_STATIC_FLAGS = -DZLIB -DBZIP2 -DSNAPPY -DLZ4 -DZSTD
JAVA_STATIC_FLAGS = -DLZ4
...
JAVA_STATIC_INCLUDES = -I./lz4-$(LZ4_VER)/lib
