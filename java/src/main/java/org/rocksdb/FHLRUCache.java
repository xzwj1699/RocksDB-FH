...
/**
 * Least Recently Used Cache FH version
 */
public class FHLRUCache extends Cache {
   ...
   */
  public FHLRUCache(final long capacity) {
   ...
   *     by hash of the key
   */
  public FHLRUCache(final long capacity, final int numShardBits) {
    super(newFHLRUCache(capacity, numShardBits, false, 0.0, 0.0));
  }
  ...
  public FHLRUCache(final long capacity, final int numShardBits,
    ...
    super(newFHLRUCache(capacity, numShardBits, strictCapacityLimit, 0.0, 0.0));
  }
   ...
   *     entries
   */
  public FHLRUCache(final long capacity, final int numShardBits, final boolean strictCapacityLimit,
      final double highPriPoolRatio) {
    super(newFHLRUCache(capacity, numShardBits, strictCapacityLimit, highPriPoolRatio, 0.0));
  }
  ...
  private static native long newFHLRUCache(final long capacity, final int numShardBits,
