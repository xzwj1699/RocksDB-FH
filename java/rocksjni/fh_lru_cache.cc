...
#include "include/org_rocksdb_FHLRUCache.h"
 ...
 * Signature: (JIZD)J
 */
jlong Java_org_rocksdb_FHLRUCache_newFHLRUCache(JNIEnv* /*env*/, jclass /*jcls*/,
                                            jlong jcapacity,
  ...
  auto* sptr_lru_cache = new std::shared_ptr<ROCKSDB_NAMESPACE::Cache>(
      ROCKSDB_NAMESPACE::NewFHLRUCache(
 ...
 * Signature: (J)V
 */
void Java_org_rocksdb_FHLRUCache_disposeInternal(JNIEnv* /*env*/,
                                               jobject /*jobj*/,
                                               jlong jhandle) {
  auto* sptr_lru_cache =
